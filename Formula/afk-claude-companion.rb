...
class AfkClaudeCompanion < Formula
  ...
  desc "Mac companion daemon for the AFK Claude remote-control app"
  homepage "https://github.com/Wadosmp4/homebrew-afk-claude"
  url "https://github.com/Wadosmp4/homebrew-afk-claude/archive/refs/tags/v0.2.0.tar.gz"
  sha256 "be731f8933fc99a7a97cfb4cd0be8dcd7179ff44b3378a5b8507cc4ebb10c0e1"
  license "MIT"
  ...
  # dependencies - re-run that whenever those version bounds change.
  ...
  resource "claude-agent-sdk" do
    url "https://files.pythonhosted.org/packages/40/4e/4aa8048367c89b9cbb64f4fac58f9f59110f77231d13e728e2844898ea32/claude_agent_sdk-0.2.134.tar.gz"
    sha256 "acac34b8068dfeb8fceeb8e2e3b3684f146da206094e55a5d34115063f2bafba"
  end
  ...
  service do
    run [opt_bin/"afk-claude-companion", "run"]
    keep_alive true
    log_path var/"log/afk-claude-companion.log"
    error_log_path var/"log/afk-claude-companion.log"
  end

  test do
    system bin/"afk-claude-companion", "--help"
  end
end
